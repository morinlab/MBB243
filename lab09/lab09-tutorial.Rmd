...
|`coord_cartesian()`|Other|Set the x and y zoom limits for a plot (similar to above but does not drop data)|
|`scale_colour_discrete()`|Colour scale|One of a variety of similarly named functions for controling the colour scale of a plot|
